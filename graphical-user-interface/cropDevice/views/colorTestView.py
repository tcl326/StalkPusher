...
class ColorTestView(v.View):
    def __init__(self, app, prevView = None):
        ...
        self.stnBtnDefs = (
            {'label': 'R', 'id': 'R_BCG', 'funct': None},
            {'label': 'G', 'id': 'G_BCG', 'funct': None},
            {'label': 'B', 'id': 'B_BCG', 'funct': None},
            {'label': 'R', 'id': 'R_BOX', 'funct': None},
            {'label': 'G', 'id': 'G_BOX', 'funct': None},
            {'label': 'B', 'id': 'B_BOX', 'funct': None},
            {'label': 'R', 'id': 'R_FONT', 'funct': None},
            {'label': 'G', 'id': 'G_FONT', 'funct': None},
            {'label': 'B', 'id': 'B_FONT', 'funct': None}
        )
...
#         self.colors = [[0]*3 for i in range(3)]
        ...
        self.stnBtnsCols = (self.cax - 30*d.px, self.cax-21*d.px, self.cax-12*d.px)
        self.stnBtnsRows = (self.cay - 10*d.py, self.cay, self.cay + 10*d.py)
        self.addStnBtns()
