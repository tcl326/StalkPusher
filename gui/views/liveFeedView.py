...
class LiveFeedView(v.View):
    def __init__(self, app, prevView = None):
        ...
        self.stnBtnDefs = (
            ...
            {'label': 'POT. ROT.', 'funct': None},
            {'label': 'IMU. ROT.', 'funct': None},
            {'label': 'ARD. TIME', 'funct': None}
        ...
        self.stnBtnsRows = (self.cay - 22*d.py, self.cay, self.cay + 22*d.py)
        self.addStnBtns()
