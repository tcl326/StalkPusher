...
#         if self.focusNum != focus:
    ...
    def startLists(self):
        ...
        self.noteLists.append(nl.NoteList(self.app, self.disp,{'x':self.cax+25*d.px,'y':self.cay, 'xdim':20*d.px, 'ydim': 50*d.py}, listName='noteBank', hasFocus=False, maxNotes = d.MAX_NOTES))# self.focusNum == len(self.noteLists)))
